...
import PaymentHistory from '../Components/Pages/Dashboard/Payment/PaymentHistory/PaymentHistory';
  ...
  // for dash board
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://bistro-boss-restaurant-server-site-psi.vercel.app/menu/${params.id}`
          ),
      },
    ],
  },
